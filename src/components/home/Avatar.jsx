...
const Avatar = ({ type = 'app', src }) => {
    ...
    // User avatar
    return (
        <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center flex-shrink-0 shadow-sm overflow-hidden">
            <img
                src="/WordTestNavBar_UserProfileButton.svg"
                alt="User Avatar"
