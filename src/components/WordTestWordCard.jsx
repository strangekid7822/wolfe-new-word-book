function WordTestWordCard() {
  return (
    <div className="bg-[var(--color-white)] p-8 rounded-3xl shadow-lg text-center max-w-md mx-auto min-h-[55vh]">
      {/* Play Button */}
      <img src="/WordTestWordCard_PlayButton.svg" alt="Play" className="w-16 h-16 mx-auto cursor-pointer hover:scale-105 transition-transform mb-6" />
